...
export class SupplierTypeEditComponent extends DefaultComponentBase implements OnInit, IUiAction<CM_SUPPLIERTYPE_ENTITY> {
    constructor(
        injector: Injector,
    ...
    goBack() {
        this.navigatePassParam('/app/admin/supplier-type', null, { filterInput: JSON.stringify(this.filterInput) });
    }
