...
import { TradeRequestDocServiceProxy, TR_REQUEST_DOC_ENTITY, ReportInfo, AsposeServiceProxy, TL_USER_ENTITY } from "@shared/service-proxies/service-proxies";
...
export class TradeRequestDocListComponent extends ListComponentBase<TR_REQUEST_DOC_ENTITY> implements IUiAction<TR_REQUEST_DOC_ENTITY>, OnInit {
    ...
    search(): void {
        ...
        this.filterInputSearch.username=this.appSession.user.userName;
