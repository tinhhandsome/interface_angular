...
import { AssAddNewServiceProxy, TRADE_DETAIL_ENTITY, CM_DEPARTMENT_ENTITY, DepartmentServiceProxy, UltilityServiceProxy, ASS_ADDNEW_ENTITY, ASS_GROUP_ENTITY, AssGroupServiceProxy, CM_DIVISION_ENTITY, CM_GOODS_ENTITY, ASS_ADDNEW_GOODS_ENTITY, ReportInfo, SysParametersServiceProxy, SYS_PARAMETERS_ENTITY } from '@shared/service-proxies/service-proxies';
...
export class AssTAddNewKTEditComponent extends DefaultComponentBase implements OnInit, IUiAction<ASS_ADDNEW_ENTITY>, AfterViewInit {
    ...
    onSelectConMaster(conMaster: any) {
