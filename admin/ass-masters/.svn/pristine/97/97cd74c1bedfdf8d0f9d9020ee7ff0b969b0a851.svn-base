...
@Component({
    templateUrl: './ass-use-multi-master-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class AssUseMultiMasterListComponent extends ListComponentBase<ASS_USE_MULTI_MASTER_ENTITY> implements IUiAction<ASS_USE_MULTI_MASTER_ENTITY>, OnInit, AfterViewInit {
    ...
    exportToExcel() {
        ...
        reportInfo.values = this.GetParamsFromFilter({
            reportTitle:this.l("AssUseMultiMaster_ReportTitle").toUpperCase(),
    ...
    onAdd(): void {
        this.navigatePassParam('/app/admin/ass-use-multi-master-add', null, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onUpdate(item: ASS_USE_MULTI_MASTER_ENTITY): void {
        this.navigatePassParam('/app/admin/ass-use-multi-master-edit', { id: item.useR_MASTER_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: ASS_USE_MULTI_MASTER_ENTITY): void {
        this.navigatePassParam('/app/admin/ass-use-multi-master-view', { id: item.useR_MASTER_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
