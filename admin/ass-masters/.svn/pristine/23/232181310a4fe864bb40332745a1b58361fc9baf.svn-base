...
@Component({
    templateUrl: './ass-t-add-new-kt-list.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    animations: [appModuleAnimation()]
})

export class AssTAddNewKTListComponent extends ListComponentBase<ASS_ADDNEW_ENTITY> implements IUiAction<ASS_ADDNEW_ENTITY>, OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        // set role toolbar
        this.appToolbar.setRole('AssTAddNewKT', false, true, false, false, true, true, false, true);
    ...
    exportToExcel() {
        ...
        reportInfo.pathName = "/ASS_MASTER/rpt_ass_t_addnew_kt.xlsx";
    ...
    onAdd(): void {
        this.navigatePassParam('/app/admin/ass-t-add-new-kt-add', null, { filterInput: JSON.stringify(this.filterInputSearch) });
    }

    onUpdate(item: ASS_ADDNEW_ENTITY): void {
        this.navigatePassParam('/app/admin/ass-t-add-new-kt-edit', { id: item.addneW_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
    ...
    onViewDetail(item: ASS_ADDNEW_ENTITY): void {
        this.navigatePassParam('/app/admin/ass-t-add-new-kt-view', { id: item.addneW_ID }, { filterInput: JSON.stringify(this.filterInputSearch) });
    }
