...
@Component({
    selector: 'ass-add-new-table-edit-po',
    templateUrl: './ass-add-new-table-edit-po.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    animations: [appModuleAnimation()]
})
export class AssAddNewTableEditPoComponent extends ChangeDetectionComponent implements AfterViewInit {
    constructor(
        injector: Injector,
    ) {
        super(injector);
    ...
    showPoGoodsModal() {
        if (this.poGoodsModal.dataEditTable) {
            this.poGoodsModal.dataEditTable.allData = [];
            this.poGoodsModal.dataEditTable.tableState.pageData = [];
        }
        this.poGoodsModal.show();
    }
