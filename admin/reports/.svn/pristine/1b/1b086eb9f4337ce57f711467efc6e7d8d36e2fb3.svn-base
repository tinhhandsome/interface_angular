...
@Component({
    templateUrl: './re-status-not-complete.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class ReStatusNotCompleteComponent extends DefaultComponentBase implements OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        this.filterInput.USE_STATUS = ''
        this.filterInput.STATUS = 'CHT'
    ...
    private getReportParameters(): ReportInfo {
        ...
        reportInfo.values = this.GetParamsFromFilter({
            ...
            reportCode: 'BDS_BC03',
            A3: this.l("ReStatusNotCompleteReportTitle")
        });
        return reportInfo
    }
