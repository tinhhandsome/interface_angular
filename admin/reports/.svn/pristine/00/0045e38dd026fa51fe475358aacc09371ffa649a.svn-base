...
@Component({
    templateUrl: './ccld-bc08-2.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class CCLDBc08_2Component extends DefaultComponentBase implements OnInit, AfterViewInit {
    ...
    exportToExcel() {
        ...
        reportInfo.pathName = "/REPORT/CCLD_BC08_2.xlsx";
        reportInfo.storeName = "rpt_CCLD_BC8_2";
    ...
    showReportTemplate() {
        ...
        this.reportTemplate.show('CCLDBc08_2_report', parameters, values);
        this.showSuccessMessage(this.l('ExportFileSuccess'));
        this.isShowError = false;
        this.updateView();
    }
