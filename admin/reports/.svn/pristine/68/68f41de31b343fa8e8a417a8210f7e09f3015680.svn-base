...
@Component({
    templateUrl: './common-collect-list.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class CommonCollectListComponent extends DefaultComponentBase implements OnInit, AfterViewInit {
    filterInput: any = {};
    ...
    exportToExcel() {
        ...
        reportInfo.pathName = "/REPORT/III.13 BAO CAO DM TAI SAN THU HOI VAO KHO.xlsx";
        reportInfo.storeName = "rpt_QLTS_16_THUHOIKHO";
