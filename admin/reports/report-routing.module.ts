...
import { HCQTStorageAsset } from './hcqt-bc01/hcqt-bc01.component';
        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'pl-overall', component: PlOverallComponent, data: { permission: 'Pages.Administration.planingoverall' } },
                    // Báo cáo PO
                    ...
                    { path: 're-con-request-doc', component: BcConRequestDocComponent, data: { permission: 'Pages.Administration.BcConRequestDoc' } },
                    // Báo cáo
                    ...
                    { path: 'hcqt-storage-asset', component : HCQTStorageAsset, data: { permission: 'Pages.Administration.HCQTStorageAsset' }}
