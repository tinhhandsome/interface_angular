...
@Component({
    templateUrl: './car-list-sys.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class CarListSystemComponent extends DefaultComponentBase implements OnInit, AfterViewInit {
    ...
    exportToExcel() {
        ...
        reportInfo.pathName = "/REPORT/XE_BC01.xlsx";
        reportInfo.storeName = "rpt_XE_BC01_Excel";
    ...
    printCarListSystem_p() {
        ...
        // this.previewTemplateService.printReportTemplate('CarListSystem_Report', parameters, values);
        this.previewTemplateModal.show('CarListSystem_Report', parameters, values);
    }
