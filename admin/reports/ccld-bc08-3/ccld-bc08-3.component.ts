...
@Component({
    templateUrl: './ccld-bc08-3.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class CCLDBc08_3Component extends DefaultComponentBase implements OnInit, AfterViewInit {
    ...
    exportToExcel() {
        ...
        reportInfo.pathName = "/REPORT/CCLD_BC08_3.xlsx";
        reportInfo.storeName = "rpt_CCLD_BC8_3";
    ...
    showReportTemplate() {
        ...
        this.reportTemplate.show('CCLDBc08_3_report', parameters, values);
        this.showSuccessMessage(this.l('ExportFileSuccess'));
        this.isShowError = false;
        this.updateView();
