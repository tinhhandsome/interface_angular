...
@Component({
    templateUrl: './re-status-not-use.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})

export class ReStatusNotUseComponent extends DefaultComponentBase implements OnInit, AfterViewInit {
    ...
    private getReportParameters(): ReportInfo {
        ...
        reportInfo.values = this.GetParamsFromFilter({
            ...
            reportCode: 'BDS_BC03',
            A3: this.l("ReStatusNotUseReportTitle")
        });
        return reportInfo
    }
