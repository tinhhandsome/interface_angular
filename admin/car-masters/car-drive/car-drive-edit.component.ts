...
import { CarDriveServiceProxy, CAR_DRIVE_ENTITY, UltilityServiceProxy, CAR_MASTER_ENTITY, CAR_DRIVE_DT_ENTITY, CarMasterServiceProxy, CM_ALLCODE_ENTITY } from '@shared/service-proxies/service-proxies';
...
export class CarDriveEditComponent extends DefaultComponentBase implements AfterViewInit, OnInit, IUiAction<CAR_DRIVE_ENTITY> {
